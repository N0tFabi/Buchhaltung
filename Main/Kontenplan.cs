...
namespace Main
{
    ...
    public class Kontenplan
    {
        ...
        public int[] ErfolgsKonten
        {
            get
            {
                int[] result = new int[this.ErfolgskontenLength];
                int indexCounter = 0;
        ...
        {
            bool result = false;
            string kontennummerToString = Convert.ToString(kontennummer);
        ...
        public int LieferantenKontenAmount
        {
            get
            {
                int result = 0;
