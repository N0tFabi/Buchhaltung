namespace Main
{
    ...
    public class Konto : Kontenplan
    {
        ...
        public List<List<int>> SollGegenkonten

        {
            get => this.sollGegenkonten;
        }

        public List<List<int>> HabenGegenkonten
        {
            get => this.habenGegenkonten;
        }

        public int Eintraege
        {
            get => this.habenWerte.Count + this.sollWerte.Count;
        }

        public int KontoNummer
        {
            get => this.kontoNummer;
        }

        public string[] SollDatum
        {
            get => this.sollDatum.ToArray();
        }

        public string[] HabenDatum
        {
            get => this.habenDatum.ToArray();
        }
        ...
        public decimal[] SollWerte
        {
            get => this.sollWerte.ToArray();
        }

        public decimal[] HabenWerte
        {
            get => this.habenWerte.ToArray();
        }
