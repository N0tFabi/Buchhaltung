...
namespace Main
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            bilanz.SteuernUmbuchen("31.01.2020");
            bilanz.ErfolgskontenAbschlieszen(73_107m);
            bilanz.Print();

            bilanz.CreateSchlussbilanz(2022);
            ...
            Bilanz aB = new Bilanz().ImportData(@"..\..\..\exports\Bilanz.bin");
